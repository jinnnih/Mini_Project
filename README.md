# 🚗 Vision-Guided Carwash & Parking Alignment System
...
처음 방문한 초보 운전자라면 세차기 입구의 **좁은 레일에 타이어를 정확히 맞추는 일**이 생각보다 쉽지 않아요.  
뒤에 차들이 줄지어 기다리는 상황에서 앞뒤로 조금씩 맞추다 보면 식은땀이 흐르기도 하죠. 😓

이 프로젝트는 그런 불편함을 해소하기 위해 시작됐습니다.

> **"카메라가 세차장 입구 기둥을 인식하고, 차량이 자동으로 정중앙에 정렬된 후 정지한다"**

초보 운전자도 세차장 입구에서 당황하지 않도록 — 카메라 비전과 ROS2 제어로 차량 정렬을 자동화하는 시스템입니다.
